...
// Returns the current flag owner by flag color or null if it isn't currently grabbed.
function getFlagOwner(color)
{
    return flagOwner[color]
}

// Called when an actor shoots a target.
...
// Sets the team_has_flag knowledge for all team members of a specific color.
