...
win32:CONFIG(release, debug|release): LIBS += -L$$OUT_PWD/../ailib/LinearMath/$$M_BUILD_DIR/ -lLinearMath
else:unix: LIBS += -L$$OUT_PWD/../ailib/LinearMath/ -lLinearMath

INCLUDEPATH += $$PWD/../ailib/LinearMath
DEPENDPATH += $$PWD/../ailib/LinearMath

win32-g++: PRE_TARGETDEPS += $$OUT_PWD/../ailib/LinearMath/$$M_BUILD_DIR/libLinearMath.a
else:win32:!win32-g++: PRE_TARGETDEPS += $$OUT_PWD/../ailib/LinearMath/$$M_BUILD_DIR/LinearMath.lib
